...
final class SQLiteInvitationRepository extends AbstractRepository implements InvitationRepositoryInterface
{
    public function save(Invitation $invitation): void
    {
        $stmt = $this->pdo->prepare(
            "INSERT INTO invitations
             ...
             VALUES
                (:id, :tenant_id, :invited_by, :email, :role, :token, :accepted_at, :expires_at, datetime('now'))"
        );
        $stmt->execute([
            'id'          => $invitation->getId(),
