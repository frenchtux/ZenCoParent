...
final class User
{
    public function __construct(
        ...
        private readonly bool                $mustChangeCredentials = false,
    ) {}
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            mustChangeCredentials: (bool) ($data['must_change_credentials'] ?? false),
        );
    }
    ...
    public function withCredentialsChanged(string $newEmail, string $newPasswordHash): self
    {
        return new self(
            id:                    $this->id,
            tenantId:              $this->tenantId,
    ...
    public function mustChangeCredentials(): bool
    {
